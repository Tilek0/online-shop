<template>
  <div class="home">
    <div class="home-main">
      <div
          class="home-main-cards"
          v-for="(item,index) in mainPage"
          :key="item.name"
          @mouseover="showPhoto(index)"
          @mouseleave="clearHover"
      >
        <my-button class="home-main-cards_text" @myButtonEvent="linkPage">{{item.name}}</my-button>
        <div class="home-main-cards_png" :style="item.style">
          <img :src="require('../assets/'+ item.image)" alt="img">
        </div>
      </div>
      <div class="home-main-backPng" v-if="hoverImage.backSide" :style="hoverImage.style">
  ...
  data() {
    return {
      mainPage: [
        ...
        {name:'BOY',image: 'boy.png', style: {left: '-70%', width: '130%'}},
      ],
      backImage: [
        ...
        {backSide: 'boy.png',style: {right: '10.8%', width: '20%'}},
      ],
      hoverImage: '',
